...
Dane i model dołączono do pakietu lokalnego; nie są automatycznie dodawane do Git. Git zawiera manifest z hashami, kod, protokół i wyniki. Nie skonfigurowano zdalnego repozytorium.
